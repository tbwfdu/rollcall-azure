...
class _RollcallManagerHomePageState extends State<RollcallManagerHomePage>
            ...
            return ContentDialog(
              ...
              content: Column(
                ...
                children: [
                  ...
                  Visibility(
                    visible: !loading,
                    child: Text('Rollcall Mode: ' + radioButtons[_dirIndex]),
                  ),
                  Visibility(
                      visible: loading,
                      child: Center(
  ...
  Future _setPrefs() async {
    ...
    if (_dirIndex == 0) {
      await prefs.setString('mode', 'azure');
    }
    if (_dirIndex == 1) {
                      ...
                      Row(
                        children: [
                          if (mode == 'google')
                            Padding(
                                padding:
                                    const EdgeInsets.fromLTRB(0, 28, 10, 0),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(
                                  width: 600,
                                  child: Text(
                                    'Choose either Azure AD or Google to set the Rollcall Mode.',
                                    style: TextStyle(
                                        fontFamily: 'SegoeUI',
                                        fontStyle: FontStyle.italic),
                                  ),
                                ...
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: List.generate(radioButtons.length,
                                      (index) {
                                    return Column(children: [
                                      RadioButton(
                                        checked: _dirIndex == index,
          ...
          Row(
            ...
            children: [
              ...
              FilledButton(
                  child: Text('Confirm'),
                  onPressed: () {
                    if (_rollcallAPI.text != "" && _rollcallPASS != "")
                      _confirm(context);
                  })
            ],
          ),
